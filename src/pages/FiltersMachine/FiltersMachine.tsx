...
const ALL_EMPLOYEES = "Toda la maquinaria";
...
export default function FiltersEmployee() {
  ...
  const { works, filterByMachine } = useWorks(changeLoading);
  const { machinesName } = useMachines(changeLoading);
        ...
        <form>
          <div className="filters_header">
            <SelectInput
              ...
              value={date}
              items={["Toda la maquinaria", ...machinesName]}
